		...
		<div id="list-demandeVisiteMusee" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="dateDemandeVisite" title="${message(code: 'demandeVisiteMusee.dateDemandeVisite.label', default: 'Date Demande Visite')}" />
				...
				<g:each in="${demandeVisiteMuseeInstanceList}" status="i" var="demandeVisiteMuseeInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${demandeVisiteMuseeInstance.id}">${fieldValue(bean: demandeVisiteMuseeInstance, field: "dateDemandeVisite")}</g:link></td>
