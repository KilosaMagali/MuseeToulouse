	...
	<body>
		...
		<div id="show-demandeVisiteMusee" class="content scaffold-show" role="main">
			...
			<ol class="property-list demandeVisiteMusee">
				...
				<g:if test="${demandeVisiteMuseeInstance?.dateDemandeVisite}">
				<li class="fieldcontain">
					<span id="dateDemandeVisite-label" class="property-label"><g:message code="demandeVisiteMusee.dateDemandeVisite.label" default="Date Demande Visite" /></span>
					
						<span class="property-value" aria-labelledby="dateDemandeVisite-label"><g:formatDate date="${demandeVisiteMuseeInstance?.dateDemandeVisite}" /></span>
